...
const CheckoutPage = () => {
          ...
          <div key={`${key}-${index}`} className="mb-4">
            ...
            <div className="text-[16px] font-semibold bg-white p-4 border border-black rounded-lg flex flex-col md:flex-row gap-4">
              ...
              <div className="w-full md:w-[20%]">
                <p className="mb-2">
                  Gender<span className="text-primary font-normal"> *</span>
                </p>
                <select
                  className="font-normal border border-black rounded-md w-full h-[50px] px-3"
              ...
              <div className="w-full md:w-[30%]">
                <p className="mb-2">
                  Birthday<span className="text-primary font-normal"> *</span>
                </p>
                <input
                  type="date"
                  className="font-normal border border-black rounded-md w-full h-[50px] px-3"
  ...
  const handleCheckout = async (): Promise<void> => {
    ...
    try {
      ...
      const paymentRes = await axios.post<PaymentResponse>(
    ...
    const fetchDeparture = async () => {
      try {
        const response = await axios.get(
          `${baseURL}/public/departures/${id_depa}`
        );
  ...
  return (
    <div className="flex flex-col md:flex-row gap-8 px-24 mt-24">
      <div className="w-full md:w-2/3">
        <h2 className="font-semibold mb-4" style={{ fontSize: "40px" }}>
          Trip Overview
        </h2>
        <div className="mt-12">
          <h4
          ...
          <div className="w-full bg-white border border-black rounded-lg p-8">
            <h5
              className="font-semibold text-base mb-8 uppercase text-center"
              style={{ fontSize: "20px" }}
            >
              Contact Information
            </h5>
            ...
            >
              ...
              <div>
                <p className="mb-1 font-semibold">
                  Email<span className="text-primary font-normal"> *</span>
                </p>
                <input
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <p className="mb-1 font-semibold">
                  Phone<span className="text-primary font-normal"> *</span>
                </p>
                <input
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    onClick={() =>
                      handleChangePassenger(key as keyof typeof passengers, -1)
                    }
                  >
                    <FaMinus size={12} className="text-primary" />
                  </button>
                  <span className="w-6 text-center font-normal text-primary">
        ...
        <div className="mt-16">
          ...
          <p className="mb-3 text-[16px]">
            If you have any notes, please tell us!
          </p>
        ...
        <div className="mt-8 text-[16px] bg-white border text-center border-black p-4 rounded-lg mb-8">
          <p>
            By clicking the "AGREE" button below, the Customer agrees that these
            Terms and Conditions will apply. Please read the Terms and
            Conditions carefully before choosing to use the services of B&P
            Tours.
          </p>
          <div className="flex justify-center">
            <label className="flex items-center gap-1">
              <input
                type="checkbox"
                onClick={() => setIsAgreeTerm(!isAgreeTerm)}
      ...
      <div className="w-full md:w-1/3 ml-4 md:ml-32 bg-white p-8 border border-primary rounded-lg shadow-xl flex flex-col self-start">
        <div>
          <p className="uppercase font-semibold text-[20px] mb-4">
            {tour?.title}
          </p>
        ...
        <div className="w-full flex">
          ...
          />
          <button className="w-1/4 uppercase font-semibold bg-primary text-white p-2">
            Apply
          </button>
        </div>
        <div className="border my-5"></div>
        ...
        <div className="text-primary font-bold flex justify-between text-center items-center">
          ...
          <p style={{ fontSize: "32px" }}>
            ...
            <span style={{ fontSize: "16px" }}> VNĐ</span>
          </p>
        </div>
        <div className="border my-5"></div>
        <div>
          <button
            ...
            className="uppercase p-4 text-white bg-primary font-bold rounded-lg w-full text-[22px]"
          >
            Checkout
          </button>
        </div>
