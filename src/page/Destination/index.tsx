...
const DestinationPage = () => {
  ...
  const scrollToNorthSection = () => {
    const northSection = document.getElementById("north-section");
    if (northSection) {
      northSection.scrollIntoView({ behavior: "smooth", block: "start" });
    }
  };
    ...
    <div>
      ...
      >
        ...
        <div className="justify-center flex mt-12">
          <button
            onClick={scrollToNorthSection}
            className="flex items-center text-[24px] bg-primary border border-white text-white rounded-2xl font-semibold px-4 py-2 mt-4 hover:bg-primary-dark transition duration-300 ease-in-out"
          >
            Begin Your Journey
