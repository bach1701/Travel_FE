...
const Review = () => {
  ...
  const user = [
    {
      ...
      rating: 5,
      review:
        "Lorem ipsum dolor sit amet consectetur. Porta ullamcorper vitae sem nec sem feugiat volutpat. Lorem ipsum dolor sit amet consectetur. Porta ullamcorper vitae sem nec sem feugiat volutpat.",
    },
  ];
  ...
  useEffect(() => {
    const fetchReview = async () => {
      try {
        const response = await axios(`${baseURL}/public/reviews/tours/28`);
      ...
      {haveReview && (
        <div className="flex items-stretch px-36 py-28">
          ...
          <div className="flex-1 text-center bg-white border-2 border-primary rounded-2xl px-24 py-16 shadow-lg relative">
            ...
            <div className="pb-4">
              <StarRatings
                rating={Number(reviewData?.averageRating?.overall_rating) || 0}
