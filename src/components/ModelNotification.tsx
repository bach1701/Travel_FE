...
const ModelNotification: React.FC<NotificationProps> = ({ 
    ...
    return (
        <div className={`fixed top-4 right-4 w-80 p-4 ${bgColor} border ${borderColor} border-solid rounded-md shadow-lg z-50`}>
            <div className="flex justify-between items-center mb-2">
                ...
                <button onClick={handleClose} className="text-gray-500 hover:text-gray-700 focus:outline-none"><FaTimesCircle className="text-lg"></FaTimesCircle></button>
            </div>
